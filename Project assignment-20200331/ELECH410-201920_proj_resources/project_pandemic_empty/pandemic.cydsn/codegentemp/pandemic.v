...
// keyboard_4x3(CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=keyboard_4x3, CY_CONFIG_TITLE=KB, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=KB, CY_INSTANCE_SHORT_NAME=KB, CY_MAJOR_VERSION=0, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=KB, )
module keyboard_4x3_0 ;



	wire [0:0] tmpOE__KeyboardCol1_net;
	wire [0:0] tmpFB_0__KeyboardCol1_net;
	wire [0:0] tmpIO_0__KeyboardCol1_net;
	wire [0:0] tmpINTERRUPT_0__KeyboardCol1_net;
	electrical [0:0] tmpSIOVREF__KeyboardCol1_net;

	cy_psoc3_pins_v1_10
		#(.id("4d90a2c0-996c-45dd-946f-084d09bd0b4b/e798c78e-098f-4d29-9440-3d8d738d21ab"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		KeyboardCol1
		 (.oe(tmpOE__KeyboardCol1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__KeyboardCol1_net[0:0]}),
		  .io({tmpIO_0__KeyboardCol1_net[0:0]}),
		  .siovref(tmpSIOVREF__KeyboardCol1_net),
		  .interrupt({tmpINTERRUPT_0__KeyboardCol1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__KeyboardCol1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__KeyboardCol3_net;
	wire [0:0] tmpFB_0__KeyboardCol3_net;
	wire [0:0] tmpIO_0__KeyboardCol3_net;
	wire [0:0] tmpINTERRUPT_0__KeyboardCol3_net;
	electrical [0:0] tmpSIOVREF__KeyboardCol3_net;

	cy_psoc3_pins_v1_10
		#(.id("4d90a2c0-996c-45dd-946f-084d09bd0b4b/72c4fde9-248a-45d2-abbb-b2182bfb8bed"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		KeyboardCol3
		 (.oe(tmpOE__KeyboardCol3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__KeyboardCol3_net[0:0]}),
		  .io({tmpIO_0__KeyboardCol3_net[0:0]}),
		  .siovref(tmpSIOVREF__KeyboardCol3_net),
		  .interrupt({tmpINTERRUPT_0__KeyboardCol3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__KeyboardCol3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__KeyboardCol2_net;
	wire [0:0] tmpFB_0__KeyboardCol2_net;
	wire [0:0] tmpIO_0__KeyboardCol2_net;
	wire [0:0] tmpINTERRUPT_0__KeyboardCol2_net;
	electrical [0:0] tmpSIOVREF__KeyboardCol2_net;

	cy_psoc3_pins_v1_10
		#(.id("4d90a2c0-996c-45dd-946f-084d09bd0b4b/db8f0b4d-868b-4342-9cfa-e0ba99d99925"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		KeyboardCol2
		 (.oe(tmpOE__KeyboardCol2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__KeyboardCol2_net[0:0]}),
		  .io({tmpIO_0__KeyboardCol2_net[0:0]}),
		  .siovref(tmpSIOVREF__KeyboardCol2_net),
		  .interrupt({tmpINTERRUPT_0__KeyboardCol2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__KeyboardCol2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__KeyboardRow0_net;
	wire [0:0] tmpFB_0__KeyboardRow0_net;
	wire [0:0] tmpIO_0__KeyboardRow0_net;
	wire [0:0] tmpINTERRUPT_0__KeyboardRow0_net;
	electrical [0:0] tmpSIOVREF__KeyboardRow0_net;

	cy_psoc3_pins_v1_10
		#(.id("4d90a2c0-996c-45dd-946f-084d09bd0b4b/c70355d5-156d-45a5-a1b3-16eefda25493"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		KeyboardRow0
		 (.oe(tmpOE__KeyboardRow0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__KeyboardRow0_net[0:0]}),
		  .io({tmpIO_0__KeyboardRow0_net[0:0]}),
		  .siovref(tmpSIOVREF__KeyboardRow0_net),
		  .interrupt({tmpINTERRUPT_0__KeyboardRow0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__KeyboardRow0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__KeyboardRow1_net;
	wire [0:0] tmpFB_0__KeyboardRow1_net;
	wire [0:0] tmpIO_0__KeyboardRow1_net;
	wire [0:0] tmpINTERRUPT_0__KeyboardRow1_net;
	electrical [0:0] tmpSIOVREF__KeyboardRow1_net;

	cy_psoc3_pins_v1_10
		#(.id("4d90a2c0-996c-45dd-946f-084d09bd0b4b/1670aaf9-9bb2-41d8-8f45-3dbaadcaf05f"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		KeyboardRow1
		 (.oe(tmpOE__KeyboardRow1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__KeyboardRow1_net[0:0]}),
		  .io({tmpIO_0__KeyboardRow1_net[0:0]}),
		  .siovref(tmpSIOVREF__KeyboardRow1_net),
		  .interrupt({tmpINTERRUPT_0__KeyboardRow1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__KeyboardRow1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__KeyboardRow2_net;
	wire [0:0] tmpFB_0__KeyboardRow2_net;
	wire [0:0] tmpIO_0__KeyboardRow2_net;
	wire [0:0] tmpINTERRUPT_0__KeyboardRow2_net;
	electrical [0:0] tmpSIOVREF__KeyboardRow2_net;

	cy_psoc3_pins_v1_10
		#(.id("4d90a2c0-996c-45dd-946f-084d09bd0b4b/16b2793f-164b-4336-b1f9-fecebb0a8ad3"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		KeyboardRow2
		 (.oe(tmpOE__KeyboardRow2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__KeyboardRow2_net[0:0]}),
		  .io({tmpIO_0__KeyboardRow2_net[0:0]}),
		  .siovref(tmpSIOVREF__KeyboardRow2_net),
		  .interrupt({tmpINTERRUPT_0__KeyboardRow2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__KeyboardRow2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__KeyboardRow3_net;
	wire [0:0] tmpFB_0__KeyboardRow3_net;
	wire [0:0] tmpIO_0__KeyboardRow3_net;
	wire [0:0] tmpINTERRUPT_0__KeyboardRow3_net;
	electrical [0:0] tmpSIOVREF__KeyboardRow3_net;

	cy_psoc3_pins_v1_10
		#(.id("4d90a2c0-996c-45dd-946f-084d09bd0b4b/28f33756-4451-4536-a722-57a0b394eed1"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		KeyboardRow3
		 (.oe(tmpOE__KeyboardRow3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__KeyboardRow3_net[0:0]}),
		  .io({tmpIO_0__KeyboardRow3_net[0:0]}),
		  .siovref(tmpSIOVREF__KeyboardRow3_net),
		  .interrupt({tmpINTERRUPT_0__KeyboardRow3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__KeyboardRow3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
...
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("6a6beef3-1151-4a5f-809e-6deb92a26988/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("f1e98573-2bd5-46cb-a15f-80976e1302b6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4feb776c-8c10-4f10-af1f-0b47963e945b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("bc103d7a-0686-4f0b-a402-009ebe7d4835"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
